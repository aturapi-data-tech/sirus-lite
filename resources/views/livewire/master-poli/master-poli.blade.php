<div>
    ...
    <div class="w-full h-[calc(100vh-68px)] bg-white border border-gray-200 px-4 pt-6">
        ...
        <div class="flex justify-between">
            ...
            @if ($isOpen)
                @include('livewire.master-poli.create')
            @endif
                        ...
                        <tr class="border-b group dark:border-gray-700">
                            ...
                            <td class="px-4 py-3 group-hover:bg-gray-100 group-hover:text-primary">
                                ...
                                <div class="inline-flex">
                                    ...
                                    <div>
                                        <x-light-button id="dropdownButton{{ $myQData->poli_id }}" class="inline-flex"
                                            wire:click="$emit('pressDropdownButton','{{ $myQData->poli_id }}')">
                                        ...
                                        <div id="dropdownMenu{{ $myQData->poli_id }}"
                                            class="z-10 hidden w-auto bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700">
                                            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                                aria-labelledby="dropdownButton{{ $myQData->poli_id }}">
                                                {{-- <li>
                                                    <x-dropdown-link wire:click="tampil('{{ $myQData->poli_id }}')">
                                                        {{ __('Tampil | ' . $myQData->poli_desc) }}
                                                    </x-dropdown-link>
                                                </li> --}}
                                                <li>
                                                    <x-dropdown-link
                                                        wire:click="edit('{{ $myQData->poli_id }}','{{ $myQData->poli_desc }}')">
                                                        {{ __('Ubah') }}
                                                    </x-dropdown-link>
                                                </li>
                                                <li>
                                                    <x-dropdown-link
                                                        wire:click="delete('{{ $myQData->poli_id }}','{{ $myQData->poli_desc }}')">
                                                        {{ __('Hapus') }}
                                                    </x-dropdown-link>
                                                </li>
