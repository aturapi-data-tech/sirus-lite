                ...
                <x-border-form :title="__('')" :align="__('start')" :bgcolor="__('bg-gray-50')" class="pb-4 mx-4">
                    ...
                    <div class="mb-4">
                        ...
                        <p class="mt-2 rounded-lg text-gray-900 text-xs {{ $propertyDiffInDays }}">
                            Masa berlaku Rujukan {{ $tglRujukanAwal->format('d/m/Y') }} s/d
                    ...
                    <div class="space-y-4">
                        ...
                        <!-- Nomor Rujukan -->
                        <div class="grid items-center grid-cols-4 gap-4">
                            <x-input-label for="noRujukan" :value="__('Nomor Rujukan')" class="text-right" :required="__($errors->has('SEPJsonReq.request.t_sep.rujukan.noRujukan'))" />

                            <div class="col-span-3">
                                <x-text-input id="noRujukan" placeholder="Isi dengan data yang sesuai" class="w-full"
                                    :errorshas="__($errors->has('SEPJsonReq.request.t_sep.rujukan.noRujukan'))" :disabled="false"
                        ...
                        @if ($JenisKunjungan['JenisKunjunganId'] == 3)
                            <div class="grid items-center grid-cols-4 gap-4">
                                <x-input-label for="noSurat" :value="__('Nomor SKDP')" class="text-right"
                                    :required="__($errors->has('SEPJsonReq.request.t_sep.skdp.noSurat'))" />

                                <div class="col-span-3">
                                    <x-text-input id="noSurat" placeholder="Isi dengan data yang sesuai"
                                        class="w-full" :errorshas="__($errors->has('SEPJsonReq.request.t_sep.skdp.noSurat'))" :disabled="false"
                        ...
                        <div class="grid grid-cols-4 gap-4">
                            ...
                            <div class="col-span-3 space-y-2">
                                <x-text-input id="noMR" placeholder="Isi dengan data yang sesuai" class="w-full"
                                ...
                                <div class="flex flex-wrap gap-4">
                                    ...
                                    <x-radio-button label="Non-Katarak" value="0"
                                        wire:model="SEPJsonReq.request.t_sep.katarak.katarak" :disabled="$disabledProperty ?? false" />

                                    <x-radio-button label="Katarak" value="1"
                                        wire:model="SEPJsonReq.request.t_sep.katarak.katarak" :disabled="$disabledProperty ?? false" />
                                </div>
                        ...
                        <!-- Status Kecelakaan -->
                        <div class="grid items-center grid-cols-4 gap-4">
                            <x-input-label for="lakaLantas" :value="__('Status Kecelakaan')" class="text-right"
                                :required="__($errors->has('SEPJsonReq.request.t_sep.jaminan.lakaLantas'))" />

                            <div class="col-span-3">
                                <x-text-input id="lakaLantas" placeholder="Isi dengan data yang sesuai"
                                    class="w-full" :errorshas="__($errors->has('SEPJsonReq.request.t_sep.jaminan.lakaLantas'))" :disabled="$disabledProperty"
                                        ...
                                        <x-slot name="content">
                                            @foreach ($SEPQuestionnaire['tujuanKunj'] as $tujuanKunj)
                                                <x-dropdown-link
                                                    ...
                                                    {{ $tujuanKunj['tujuanKunjId'] }}
                                                    {{ $tujuanKunj['tujuanKunjDesc'] }}
                                                </x-dropdown-link>
                                            @endforeach
                                        </x-slot>
                                    </x-dropdown>
