                            ...
                            <div>
                                <div class="flex items-center mb-2">
                                    <x-text-input id="pasporidentitas" placeholder="Tanggal [ dd/mm/yyyy hh24:mi:ss ]"
                                        class="mt-1 ml-2 sm:w-[160px]" :errorshas="__($errors->has('dataDaftarPoliRJ.rjDate'))"
                        ...
                        <div id="DataPasien" class="px-4 bg-white">
                            ...
                            <div class="px-4 bg-white snap-mandatory snap-y">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex items-center mb-2">
                                            ...
                                            <x-text-input placeholder="Nama Panggilan" class="mt-1 ml-2 sm:w-1/4"
                                                :errorshas="__($ruleDataPasien['pasien']['namaPanggilan'])" :disabled=$disabledProperty
                                    ...
                                    <div>
                                        ...
                                        <div class="flex items-center mb-2">
                                            <x-text-input id="tempatLahir" placeholder="Tempat Lahir"
                                                class="mt-1 ml-2 sm:w-1/2" :errorshas="__($ruleDataPasien['pasien']['tempatLahir'])"
                                                :disabled=$disabledProperty
                                                wire:model.debounce.500ms="dataPasien.pasien.tempatLahir"
                                                style="text-transform:uppercase" />
                                            <x-text-input placeholder="Tgl Lahir [dd/mm/yyyy]"
                                                class="mt-1 ml-2 sm:w-1/2" :errorshas="__($ruleDataPasien['pasien']['tglLahir'])"
                                                :disabled=$disabledProperty
                                    ...
                                    <x-border-form :title="__('Budaya')" :align="__('start')" :bgcolor="__('bg-gray-50')">
                                        <div>
                                            <div class="flex items-center mb-2">
                                                ...
                                                <x-input-label for="Kewarganegaraan" :value="__('Kewarga Negaraan')"
                                                    :required="__($ruleDataPasien['pasien']['kewarganegaraan'])" class="sm:w-1/5" />
                                                ...
                                                <div class="mt-1 ml-2 sm:w-1/5">
                                                    <div class="flex ">
                                                        <x-text-input placeholder="status"
                                                            class="sm:rounded-none sm:rounded-l-lg" :errorshas="__(
                                                                $ruleDataPasien['pasien']['status']['statusId'],
                                                            )"
                                                            :disabled=true
                                ...
                                <div id="AlamatIdentitas" class="flex ">
                                    <x-border-form :title="__('Identitas')" :align="__('start')" :bgcolor="__('bg-gray-50')"
                                        class="mr-2">
                                        ...
                                        <div class="grid grid-cols-2">
                                            ...
                                            <div>
                                                    ...
                                                    <div class="flex items-center mb-2">
                                                        <x-text-input id="nikidentitas" placeholder="NIK"
                                                            class="mt-1 ml-2" :errorshas="__(
                                                                $ruleDataPasien['pasien']['identitas']['nik'],
                                                            )"
                                                            :disabled=$disabledProperty
                                                ...
                                                <div>
                                                    ...
                                                    <div class="flex items-center mb-2">
                                                        <x-text-input id="idBpjsidentitas"
                                                            placeholder="Id BPJS [13digit]" class="mt-1 ml-2"
                                                            :errorshas="__(
                                                                $ruleDataPasien['pasien']['identitas']['idbpjs'],
                                                            )" :disabled=$disabledProperty
                                                ...
                                                <div>
                                                    ...
                                                    <div class="flex items-center mb-2">
                                                        <x-text-input id="Alamatidentitas" placeholder="Alamat"
                                                            class="mt-1 ml-2" :errorshas="__(
                                                                $ruleDataPasien['pasien']['identitas']['alamat'],
                                                            )"
                                                            :disabled=$disabledProperty
                                                ...
                                                <div>
                                                    ...
                                                    <div class="flex items-center mb-2">
                                                        ...
                                                        <x-text-input id="rtrwidentitas" placeholder="RT [3digit]"
                                                            class="mt-1 ml-2 sm:w-1/3" :errorshas="__(
                                                                $errors->has('dataPasien.pasien.identitas.rt'),
                                                            )"
                                                            :disabled=$disabledProperty
                                                            wire:model.debounce.500ms="dataPasien.pasien.identitas.rt" />

                                                        <x-text-input placeholder="RW [3digit]"
                                                            class="mt-1 ml-2 sm:w-1/3" :errorshas="__(
                                                                $errors->has('dataPasien.pasien.identitas.rw'),
                                                            )"
                                                            :disabled=$disabledProperty
                                                            wire:model.debounce.500ms="dataPasien.pasien.identitas.rw" />
                                                        <x-text-input placeholder="Kode Pos"
                                                            class="mt-1 ml-2 sm:w-1/3" :errorshas="__(
                                                    ...
                                                    <div hidden>
                                                        <p class="text-xs font-normal text-gray-500">Jika
                                                            Pasien (Tidak
                                                            dikenal)
                                                            NIK
                                                            di isi
                                                            Kosong</p>
                                                        <p class="text-xs font-normal text-gray-500">* Isi
                                                            alamat sesuai
                                                            dengan
                                                            ditemukannya
                                                            pasien</p>
                                                        <br>
                                                        <p class="text-xs font-normal text-gray-500">Untuk
                                                            Pasien Bayi Baru
                                                            lahir
                                                        </p>
                                                        <p class="text-xs font-normal text-gray-500">* Isi NIK
                                                            dgn "NIK Ibu
                                                            bayi"
                                                            dan nama bayi
                                                    ...
                                                    <div class="mt-1">
                                                        ...
                                                        <div class="flex mb-2 ml-2 ">
                                                            <x-text-input placeholder="Desa"
                                                                class="sm:rounded-none sm:rounded-l-lg"
                                                                :errorshas="__(
                                                                    $ruleDataPasien['pasien']['identitas']['desaName'],
                                                                )" :disabled=true
                                                ...
                                                <div>
                                                    ...
                                                    <div class="flex items-center mb-2">
                                                        <x-text-input id="negaraidentitas"
                                                            ...
                                                            :errorshas="__(
                                                                $ruleDataPasien['pasien']['identitas']['negara'],
                                                            )" :disabled=$disabledProperty
                                    ...
                                    <x-border-form :title="__('Alamat Domisil')" :align="__('start')" :bgcolor="__('bg-gray-50')"
                                        class="" hidden>
                                        ...
                                        <div>
                                            ...
                                            <div class="flex items-center mb-2">
                                                <x-text-input id="AlamatDomisil" placeholder="Alamat"
                                                    class="mt-1 ml-2" :errorshas="__($ruleDataPasien['pasien']['domisil']['alamat'])" :disabled=$disabledProperty
                                        ...
                                        <div>
                                            <x-input-label for="Propinsidomisil" :value="__('Propinsi')"
                                                :required="__($ruleDataPasien['pasien']['domisil']['propinsiId'])" />
                                            <div class="flex items-center mb-2">
                                    ...
                                    <x-border-form :title="__('Penanggung Jawab')" :align="__('start')" :bgcolor="__('bg-yellow-100')">
                                        ...
                                        <div class="flex items-center mb-2">
                                            <x-text-input id="PenanggungJawab" placeholder="Nama Penanggung Jawab"
                                                class="mt-1 ml-2" :errorshas="__(
                                                    $ruleDataPasien['pasien']['hubungan']['namaPenanggungJawab'],
                                                )" :disabled=$disabledProperty
                                        ...
                                        <x-input-label for="HungungandgnPasien" :value="__('Hungungan dgn Pasien')"
                                            :required="__(
                            ...
                            <x-border-form :title="__('Pendaftaran Rawat Jalan')" :align="__('start')" :bgcolor="__('bg-white')" class="mr-0">
                                ...
                                <div class="grid grid-cols-2">
                                    @if ($JenisKunjungan['JenisKunjunganId'] === '2')
                                        @foreach ($dataDaftarPoliRJ['internal12Options'] as $internal12)
                                            {{-- @dd($sRj) --}}
                                            <x-radio-button :label="__($internal12['internal12Desc'])"
                                                value="{{ $internal12['internal12'] }}"
                                ...
                                <div>
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs">di isi dgn : (No Rujukan untun FKTP /FKTL) (SKDP
                                            untuk
