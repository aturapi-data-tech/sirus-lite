        ...
        <div class="fixed inset-0 transition-opacity">
            <div class="absolute overflow-auto bg-white rounded-t-lg inset-4">
                ...
                <div class="grid grid-cols-1">
                    <livewire:master-dokter.form-entry-template-resep-dokter.form-entry-template-resep-dokter
                        :dokterId="$dokterId" :isOpenTemplateResepDokterMode="$isOpenTemplateResepDokterMode" :wire:key="$dokterId.'form-entry-template-resep-dokter'">
