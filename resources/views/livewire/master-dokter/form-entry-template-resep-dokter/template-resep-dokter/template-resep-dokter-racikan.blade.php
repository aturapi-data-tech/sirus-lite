<div>
    ...
    {{-- @if (isset($tempJsonRacikan['diagnosis'])) --}}
        ...
        <div id="TransaksiRawatJalan" class="p-2">
            <div class="p-2 rounded-lg bg-gray-50">
                ...
                <div id="TransaksiRawatJalan" class="px-4">
                    <x-input-label for="" :value="__('Racikan ' . $temprIdRef)" :required="__(false)" class="pt-2 sm:text-xl" />
                    @role(['Dokter', 'Admin'])
                                ...
                                <div class="overflow-hidden shadow sm:rounded-lg">
                                    <table
                                        ...
                                        <tbody class="bg-white dark:bg-gray-800">
                                            ...
                                            @isset($tempJsonRacikan['eresepRacikan'])
                                                @php
                                                    $myPreviousRow = '';
                                                @endphp
                                                @foreach ($tempJsonRacikan['eresepRacikan'] as $key => $eresep)
                                                            ...
                                                            <td
                                                                ...
                                                                <div>
                                                                    <x-text-input placeholder="dosis" class=""
                                                                        ...
                                                                        x-ref="tempJsonRacikaneresepRacikan{{ $key }}dosis"
                                                                        x-on:keyup.enter="$refs.tempJsonRacikaneresepRacikan{{ $key }}qty.focus()"
                                                                        wire:model="tempJsonRacikan.eresepRacikan.{{ $key }}.dosis" />
                                                            ...
                                                            <td
                                                                ...
                                                                <div>
                                                                    <x-text-input placeholder="Jml Racikan" class=""
                                                                        :disabled=$disabledPropertyRjStatus
                                                                        wire:model="tempJsonRacikan.eresepRacikan.{{ $key }}.qty"
                                                                        x-ref="tempJsonRacikaneresepRacikan{{ $key }}qty"
                                                                        x-on:keyup.enter="$refs.tempJsonRacikaneresepRacikan{{ $key }}catatan.focus()" />
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td
                                                                ...
                                                                <div>
                                                                    <x-text-input placeholder="Catatan" class=""
                                                                        :disabled=$disabledPropertyRjStatus
                                                                        x-ref="tempJsonRacikaneresepRacikan{{ $key }}catatan"
                                                                        x-on:keyup.enter="$refs.tempJsonRacikaneresepRacikan{{ $key }}catatanKhusus.focus()"
                                                                        wire:model="tempJsonRacikan.eresepRacikan.{{ $key }}.catatan" />
                                                            ...
                                                            <td
                                                                ...
                                                                <div>
                                                                    <x-text-input placeholder="Signa" class=""
                                                                        :disabled=$disabledPropertyRjStatus
                                                                        wire:model="tempJsonRacikan.eresepRacikan.{{ $key }}.catatanKhusus"
                                                                        x-on:keyup.enter="$wire.updateProduct('{{ $key }}','{{ $tempJsonRacikan['eresepRacikan'][$key]['dosis'] ? $tempJsonRacikan['eresepRacikan'][$key]['dosis'] : null }}','{{ $tempJsonRacikan['eresepRacikan'][$key]['qty'] ? $tempJsonRacikan['eresepRacikan'][$key]['qty'] : null }}','{{ $tempJsonRacikan['eresepRacikan'][$key]['catatan'] ? $tempJsonRacikan['eresepRacikan'][$key]['catatan'] : null }}','{{ $tempJsonRacikan['eresepRacikan'][$key]['catatanKhusus'] ? $tempJsonRacikan['eresepRacikan'][$key]['catatanKhusus'] : null }}')"
                                                                        x-ref="tempJsonRacikaneresepRacikan{{ $key }}catatanKhusus" />
