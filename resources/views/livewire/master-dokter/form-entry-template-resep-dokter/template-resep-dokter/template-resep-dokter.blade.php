<div>
    ...
    {{-- @if (isset($tempJsonNonRacikan['diagnosis'])) --}}
        ...
        <div id="TransaksiRawatJalan" class="p-2">
            <div class="p-2 rounded-lg bg-gray-50">
                ...
                <div id="TransaksiRawatJalan" class="px-4">
                    <x-input-label for="" :value="__('Non Racikan ' . $temprIdRef)" :required="__(false)" class="pt-2 sm:text-xl" />
                    @role(['Dokter', 'Admin'])
                        ...
                        @if ($collectingMyProduct)
                            ...
                            <div class="flex items-baseline space-x-2" x-data>
                                ...
                                <div class="basis-3/6">
                                    <x-input-label for="collectingMyProduct.catatanKhusus" :value="__('Catatan Khususx')"
                                        :required="__(true)" />
                                ...
                                <div class="overflow-hidden shadow sm:rounded-lg">
                                    <table
                                        ...
                                        <tbody class="bg-white dark:bg-gray-800">
                                            @isset($tempJsonNonRacikan['eresep'])
                                                @foreach ($tempJsonNonRacikan['eresep'] as $key => $eresep)
                                                        ...
                                                        <td
                                                            ...
                                                            <div>
                                                                <x-text-input placeholder="Jml Racikan" class=""
                                                                    ...
                                                                    wire:model="tempJsonNonRacikan.eresep.{{ $key }}.qty"
                                                                    x-ref="tempJsonNonRacikaneresep{{ $key }}qty"
                                                                    x-on:keyup.enter="$refs.tempJsonNonRacikaneresep{{ $key }}signaX.focus()" />
                                                            </div>
                                                        </td>
                                                                ...
                                                                <div class="basis-[20%]">
                                                                    ...
                                                                    <div>
                                                                        <x-text-input placeholder="Signa1"
                                                                            class="mt-1 ml-2"
                                                                            :disabled=$disabledPropertyRjStatus
                                                                            wire:model="tempJsonNonRacikan.eresep.{{ $key }}.signaX"
                                                                            x-ref="tempJsonNonRacikaneresep{{ $key }}signaX"
                                                                            x-on:keyup.enter="$refs.tempJsonNonRacikaneresep{{ $key }}signaHari.focus()" />
                                                                ...
                                                                <div class="basis-[20%]">
                                                                    ...
                                                                    <div>
                                                                        <x-text-input placeholder="Signa2"
                                                                            class="mt-1 ml-2"
                                                                            :disabled=$disabledPropertyRjStatus
                                                                            wire:model="tempJsonNonRacikan.eresep.{{ $key }}.signaHari"
                                                                            x-ref="tempJsonNonRacikaneresep{{ $key }}signaHari"
                                                                            x-on:keyup.enter="$refs.tempJsonNonRacikaneresep{{ $key }}catatanKhusus.focus()" />
                                                                ...
                                                                <div class="basis-3/6">
                                                                    ...
                                                                    <div>
                                                                        <x-text-input placeholder="Catatan Khusus"
                                                                            class="mt-1 ml-2"
                                                                            :disabled=$disabledPropertyRjStatus
                                                                            wire:model="tempJsonNonRacikan.eresep.{{ $key }}.catatanKhusus"
                                                                            x-on:keyup.enter="$wire.updateProduct('{{ $key ?? null }}', '{{ $tempJsonNonRacikan['eresep'][$key]['qty'] ? $tempJsonNonRacikan['eresep'][$key]['qty'] : null }}','{{ $tempJsonNonRacikan['eresep'][$key]['signaX'] ? $tempJsonNonRacikan['eresep'][$key]['signaX'] : null }}', '{{ $tempJsonNonRacikan['eresep'][$key]['signaHari'] ? $tempJsonNonRacikan['eresep'][$key]['signaHari'] : null }}', '{{ $tempJsonNonRacikan['eresep'][$key]['catatanKhusus'] ? $tempJsonNonRacikan['eresep'][$key]['catatanKhusus'] : null }}')
                                                                        $refs.tempJsonNonRacikaneresep{{ $key }}qty.focus()"
                                                                            x-ref="tempJsonNonRacikaneresep{{ $key }}catatanKhusus" />
                                                        ...
                                                        <td
                                                            ...
                                                            @role(['Dokter', 'Admin'])
                                                                <x-alternative-button class="inline-flex"
                                                                    :disabled=$disabledPropertyRjStatus
                                                                    wire:click.prevent="removeProduct('{{ $eresep['productId'] }}')">
