        ...
        <div class="inline-block overflow-auto text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl sm:max-h-[35rem] sm:my-8 sm:align-middle sm:max-w-lg sm:w-full"
            ...
            <form>
                ...
                <div class="px-4 pt-5 pb-4 bg-white sm:p-6 sm:pb-4">
                    ...
                    <div>
                        <x-input-label for="reg_no" :value="__('Nama Provinsi')" />
                        <div class="flex">
                            <x-text-input class="block sm:w-[100px] mt-1" required autofocus autocomplete="reg_no"
                                :disabled=$disabledProperty wire:model="dataPasienPoli.regNo" />
