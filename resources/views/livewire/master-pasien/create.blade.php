                    ...
                    <x-border-form :title="__('Identitas Pasien')" :align="__('start')">
                        ...
                        <x-border-form :title="__('Sosial')" :align="__('start')" :bgcolor="__('bg-gray-50')">
                            <div class="flex items-center">
                                ...
                                <x-input-label for="SPerkawinan" :value="__('Status Perkawinan')" :required="__($ruleDataPasien['pasien']['statusPerkawinan']['statusPerkawinanId'])"
                                    class="sm:w-1/5" />
                                    ...
                                    <div>
                                        ...
                                        <div class="flex items-center mb-2">
                                            <x-text-input id="Kecamatanidentitas" placeholder="Kecamatan"
                                                class="mt-1 ml-2" :errorshas="__($ruleDataPasien['pasien']['identitas']['kecamatanId'])" :disabled=true
