        ...
        <div class="pt-0">
            ...
            <div>
                ...
                @if ($isOpenLaboratorium)
                    @include('livewire.emr-r-i.mr-r-i.pemeriksaan.create-penunjang-laboratorium')
                @endif
                ...
                <table class="w-full text-sm text-left text-gray-500 table-auto ">
                    ...
                    <tbody class="bg-white ">
                        @isset($dataDaftarRi['pemeriksaan']['pemeriksaanPenunjang']['lab'])
                            @foreach ($dataDaftarRi['pemeriksaan']['pemeriksaanPenunjang']['lab'] as $key => $pemeriksaanPenunjangLab)
            ...
            <div>
                ...
                @if ($isOpenRadiologi)
                    @include('livewire.emr-r-i.mr-r-i.pemeriksaan.create-penunjang-radiologi')
                @endif
                ...
                <table class="w-full text-sm text-left text-gray-500 table-auto ">
                    ...
                    <tbody class="bg-white ">
                        @isset($dataDaftarRi['pemeriksaan']['pemeriksaanPenunjang']['rad'])
                            @foreach ($dataDaftarRi['pemeriksaan']['pemeriksaanPenunjang']['rad'] as $key => $pemeriksaanPenunjangRad)
                                <tr class="border-b group ">
            ...
            {{-- Lain --}}
            @include('livewire.emr-r-i.mr-r-i.pemeriksaan.uploadpenunjangHasil')
