            ...
            <div class="absolute overflow-auto bg-white rounded-t-lg inset-4">
                ...
                <div
                    ...
                    <div id="shiftTanggal" class="flex justify-end w-full mr-4">
                        ...
                        {{-- Close Modal --}}
                        <button @click="showCopy = false"
                            class="absolute top-2 right-2 text-gray-400 bg-gray-50 hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5">
                ...
                <div>
                    <livewire:emr.rekam-medis.rekam-medis-u-g-d :regNoRef="$dataDaftarRi['regNo']" :key="'rekam-medis-ugd-' . $dataDaftarRi['regNo']" />
                </div>
