        ...
        <div class="w-full">
            @foreach ($dataDaftarRi['pengkajianDokter']['anatomi'] as $key => $pAnatomi)
                <div class="p-4 rounded-lg bg-gray-50 dark:bg-gray-800"
                    ...
                    <x-text-input-area id="dataDaftarRi.pengkajianDokter.anatomi.{{ $key }}.kelainan"
                        placeholder="{{ strtoupper($key) }}" class="mt-1 ml-2" :errorshas="__($errors->has('dataDaftarRi.pengkajianDokter.anatomi'))"
