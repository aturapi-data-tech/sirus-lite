<div>
    ...
    <div class="grid grid-cols-2 gap-2">
        ...
        <!-- Keluhan Utama -->
        <div>
            <x-input-label for="dataDaftarRi.pengkajianDokter.anamnesa.keluhanUtama" :value="__('Keluhan Utama')"
                :required="true" />
        ...
        <div>
            ...
            <x-text-input-area id="dataDaftarRi.pengkajianDokter.anamnesa.keluhanTambahan"
                ...
                wire:model.debounce.500ms="dataDaftarRi.pengkajianDokter.anamnesa.keluhanTambahan" />
        ...
        <div>
            ...
            <div class="space-y-2">
                ...
                <x-text-input-area id="dataDaftarRi.pengkajianDokter.anamnesa.riwayatPenyakit.dahulu"
                    placeholder="Dahulu" class="mt-1"
        ...
        <!-- Jenis Alergi -->
        <div>
            <x-input-label for="dataDaftarRi.pengkajianDokter.anamnesa.jenisAlergi" :value="__('Jenis Alergi / Alergi [Makanan / Obat / Udara]')"
                :required="true" />
            <div class="space-y-2">
