            ...
            <div id="TransaksiRawatJalan" class="px-4">
                ...
                <div>
                    <div class="grid grid-cols-4 gap-2">
                        <x-input-label for="rekonsiliasiObat.namaObat" :value="__('Nama Obat')" :required="true" />
                        <x-input-label for="rekonsiliasiObat.dosis" :value="__('Dosis')" :required="true" />
                        <x-input-label for="rekonsiliasiObat.rute" :value="__('Rute')" :required="true" />
                        <x-input-label for="rekonsiliasiObat.rute" :value="__('Action')" :required="true" />
                    </div>
                    <div class="grid grid-cols-4 gap-2">
                        <div>
                            <div class="mb-2">
                        ...
                        <div class="grid grid-cols-1 ml-2">
                            ...
                            <x-yellow-button :disabled="$disabledPropertyRjStatus" wire:click.prevent="addRekonsiliasiObat()"
                ...
                <table class="w-full text-sm text-left text-gray-500 table-auto">
                    ...
                    <tbody class="bg-white">
                        @isset($dataDaftarRi['pengkajianDokter']['anamnesa']['rekonsiliasiObat'])
                            @foreach ($dataDaftarRi['pengkajianDokter']['anamnesa']['rekonsiliasiObat'] as $key => $rekonsiliasiObat)
