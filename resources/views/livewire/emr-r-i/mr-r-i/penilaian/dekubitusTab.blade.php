    ...
    <div class="w-full mb-1">
        <div class="pt-0">
            ...
            <div class="grid grid-flow-row gap-2 mt-2 ml-2">
                ...
                @foreach ($dataDaftarRi['penilaian']['dekubitus']['kodisiFisikOptions'] as $kodisiFisikOptions)
                    {{-- @dd($sRj) --}}
                    <x-radio-button :label="__($kodisiFisikOptions['kodisiFisik'])" value="{{ $kodisiFisikOptions['kodisiFisik'] }}"
                        wire:model="dataDaftarRi.penilaian.dekubitus.kodisiFisik" />
                @endforeach
            ...
            <div class="grid grid-flow-row gap-2 mt-2 ml-2">
                ...
                @foreach ($dataDaftarRi['penilaian']['dekubitus']['kesadaranOptions'] as $kesadaranOptions)
                    {{-- @dd($sRj) --}}
                    <x-radio-button :label="__($kesadaranOptions['kesadaran'])" value="{{ $kesadaranOptions['kesadaran'] }}"
                        wire:model="dataDaftarRi.penilaian.dekubitus.kesadaran" />
                @endforeach
            ...
            <div class="grid grid-flow-row gap-2 mt-2 ml-2">
                ...
                @foreach ($dataDaftarRi['penilaian']['dekubitus']['aktifitasOptions'] as $aktifitasOptions)
                    {{-- @dd($sRj) --}}
                    <x-radio-button :label="__($aktifitasOptions['aktifitas'])" value="{{ $aktifitasOptions['aktifitas'] }}"
                        wire:model="dataDaftarRi.penilaian.dekubitus.aktifitas" />
                @endforeach
            ...
            <div class="grid grid-flow-row gap-2 mt-2 ml-2">
                ...
                @foreach ($dataDaftarRi['penilaian']['dekubitus']['mobilitasOptions'] as $mobilitasOptions)
                    {{-- @dd($sRj) --}}
                    <x-radio-button :label="__($mobilitasOptions['mobilitas'])" value="{{ $mobilitasOptions['mobilitas'] }}"
                        wire:model="dataDaftarRi.penilaian.dekubitus.mobilitas" />
                @endforeach
            ...
            <div class="grid grid-flow-row gap-2 mt-2 ml-2">
                ...
                @foreach ($dataDaftarRi['penilaian']['dekubitus']['inkontinensiaOptions'] as $inkontinensiaOptions)
                    {{-- @dd($sRj) --}}
                    <x-radio-button :label="__($inkontinensiaOptions['inkontinensia'])" value="{{ $inkontinensiaOptions['inkontinensia'] }}"
                        wire:model="dataDaftarRi.penilaian.dekubitus.inkontinensia" />
                @endforeach
