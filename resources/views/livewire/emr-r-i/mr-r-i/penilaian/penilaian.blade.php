                ...
                <div id="TransaksiRawatJalan" class="px-2">
                    <div id="TransaksiRawatJalan" x-data="{ activeTab: 'Status Medik' }">
                            ...
                            <ul
                                ...
                                {{-- <li class="mr-2">
                                    <label
                                        ...
                                        :class="activeTab === '{{ $dataDaftarRi['penilaian']['fisikTab'] }}' ?
                                            'text-primary border-primary bg-gray-100' : ''"
                                        @click="activeTab ='{{ $dataDaftarRi['penilaian']['fisikTab'] }}'">{{ $dataDaftarRi['penilaian']['fisikTab'] }}</label>
                                </li> --}}

                                <li class="mr-2">
                                    <label
                                        class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300"
                                        :class="activeTab === '{{ $dataDaftarRi['penilaian']['statusMedikTab'] }}' ?
                                            'text-primary border-primary bg-gray-100' : ''"
                                        @click="activeTab ='{{ $dataDaftarRi['penilaian']['statusMedikTab'] }}'">{{ $dataDaftarRi['penilaian']['statusMedikTab'] }}</label>
                                </li>
                                ...
                                <li class="mr-2">
                                    <label
                                        ...
                                        :class="activeTab === '{{ $dataDaftarRi['penilaian']['nyeriTab'] }}' ?
                                            'text-primary border-primary bg-gray-100' : ''"
                                        @click="activeTab ='{{ $dataDaftarRi['penilaian']['nyeriTab'] }}'">{{ $dataDaftarRi['penilaian']['nyeriTab'] }}</label>
                                </li>
                                ...
                                {{-- <li class="mr-2">
                                    <label
                                        ...
                                        :class="activeTab === '{{ $dataDaftarRi['penilaian']['statusPediatrikTab'] }}' ?
                                            'text-primary border-primary bg-gray-100' : ''"
                                        @click="activeTab ='{{ $dataDaftarRi['penilaian']['statusPediatrikTab'] }}'">{{ $dataDaftarRi['penilaian']['statusPediatrikTab'] }}</label>
                                </li> --}}

                                {{-- <li class="mr-2">
                                    <label
                                        class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300"
                                        :class="activeTab === '{{ $dataDaftarRi['penilaian']['diagnosisTab'] }}' ?
                                            'text-primary border-primary bg-gray-100' : ''"
                                        @click="activeTab ='{{ $dataDaftarRi['penilaian']['diagnosisTab'] }}'">{{ $dataDaftarRi['penilaian']['diagnosisTab'] }}</label>
                                </li> --}}
                                ...
                                <li class="mr-2">
                                    <label
                                        ...
                                        '{{ $dataDaftarRi['penilaian']['resikoJatuhTab'] . $dataDaftarRi['penilaian']['resikoJatuh']['skalaMorse']['skalaMorseTab'] }}'
                                            ?
                                            'text-primary border-primary bg-gray-100' : ''"
                                        @click="activeTab ='{{ $dataDaftarRi['penilaian']['resikoJatuhTab'] . $dataDaftarRi['penilaian']['resikoJatuh']['skalaMorse']['skalaMorseTab'] }}'">{{ $dataDaftarRi['penilaian']['resikoJatuhTab'] . ' / ' . $dataDaftarRi['penilaian']['resikoJatuh']['skalaMorse']['skalaMorseTab'] }}</label>
                                </li>
                                ...
                                <li class="mr-2">
                                    <label
                                        ...
                                        '{{ $dataDaftarRi['penilaian']['resikoJatuhTab'] . $dataDaftarRi['penilaian']['resikoJatuh']['skalaHumptyDumpty']['skalaHumptyDumptyTab'] }}'
                                            ?
                                            'text-primary border-primary bg-gray-100' : ''"
                                        @click="activeTab ='{{ $dataDaftarRi['penilaian']['resikoJatuhTab'] . $dataDaftarRi['penilaian']['resikoJatuh']['skalaHumptyDumpty']['skalaHumptyDumptyTab'] }}'">{{ $dataDaftarRi['penilaian']['resikoJatuhTab'] . ' / ' . $dataDaftarRi['penilaian']['resikoJatuh']['skalaHumptyDumpty']['skalaHumptyDumptyTab'] }}</label>
                                </li>
                                ...
                                {{-- <li class="mr-2">
                                    <label
                                        class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300"
                                        :class="activeTab ===
                                        '{{ $dataDaftarRi['penilaian']['resikoJatuhTab'] . $dataDaftarRi['penilaian']['resikoJatuh']['edmonson']['edmonsonTab'] }}'
                                            ?
                                            'text-primary border-primary bg-gray-100' : ''"
                                        @click="activeTab ='{{ $dataDaftarRi['penilaian']['resikoJatuhTab'] . $dataDaftarRi['penilaian']['resikoJatuh']['edmonson']['edmonsonTab'] }}'">{{ $dataDaftarRi['penilaian']['resikoJatuhTab'] . ' / ' . $dataDaftarRi['penilaian']['resikoJatuh']['edmonson']['edmonsonTab'] }}</label>
                                </li> --}}
                                ...
                                {{-- <li class="mr-2">
                                    <label
                                        ...
                                        '{{ $dataDaftarRi['penilaian']['dekubitus']['dekubitusTab'] }}'
                                            ?
                                            'text-primary border-primary bg-gray-100' : ''"
                                        @click="activeTab ='{{ $dataDaftarRi['penilaian']['dekubitus']['dekubitusTab'] }}'">{{ $dataDaftarRi['penilaian']['dekubitus']['dekubitusTab'] }}</label>
                                </li> --}}
                        ...
                        <div class="p-2 rounded-lg bg-gray-50 dark:bg-gray-800"
                            :class="{
                                'active': activeTab === '{{ $dataDaftarRi['penilaian']['fisikTab'] }}'
                            }"
                            x-show.transition.in.opacity.duration.600="activeTab === '{{ $dataDaftarRi['penilaian']['fisikTab'] }}'">
                            @include('livewire.emr-r-i.mr-r-i.penilaian.fisikTab')

                        </div>

                        <div class="p-2 rounded-lg bg-gray-50 dark:bg-gray-800"
                            :class="{
                                'active': activeTab === '{{ $dataDaftarRi['penilaian']['statusMedikTab'] }}'
                            }"
                            x-show.transition.in.opacity.duration.600="activeTab === '{{ $dataDaftarRi['penilaian']['statusMedikTab'] }}'">
                            @include('livewire.emr-r-i.mr-r-i.penilaian.statusMedikTab')

                        </div>

                        <div class="p-2 rounded-lg bg-gray-50 dark:bg-gray-800"
                            :class="{
                                'active': activeTab === '{{ $dataDaftarRi['penilaian']['nyeriTab'] }}'
                            }"
                        ...
                        <div class="p-2 rounded-lg bg-gray-50 dark:bg-gray-800"
                            :class="{
                                'active': activeTab === '{{ $dataDaftarRi['penilaian']['statusPediatrikTab'] }}'
                            }"
                        ...
                        <div class="p-2 rounded-lg bg-gray-50 dark:bg-gray-800"
                            :class="{
                                'active': activeTab === '{{ $dataDaftarRi['penilaian']['diagnosisTab'] }}'
                            }"
                            x-show.transition.in.opacity.duration.600="activeTab === '{{ $dataDaftarRi['penilaian']['diagnosisTab'] }}'">
                            @include('livewire.emr-r-i.mr-r-i.penilaian.diagnosisTab')
                        ...
                        <div class="p-2 rounded-lg bg-gray-50 dark:bg-gray-800"
                            ...
                            x-show.transition.in.opacity.duration.600="activeTab === '{{ $dataDaftarRi['penilaian']['resikoJatuhTab'] . $dataDaftarRi['penilaian']['resikoJatuh']['edmonson']['edmonsonTab'] }}'">
                            @include('livewire.emr-r-i.mr-r-i.penilaian.edmonsonTab')
