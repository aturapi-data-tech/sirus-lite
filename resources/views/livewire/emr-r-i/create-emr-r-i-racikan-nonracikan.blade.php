            ...
            <div class="absolute overflow-auto bg-white rounded-t-lg inset-4">
                ...
                <div
                    ...
                    <div id="shiftTanggal" class="flex justify-end w-full mr-4">
                        ...
                        {{-- Close Modal --}}
                        <button wire:click="closeModalEresepRI()"
                ...
                <div class="">
                    ...
                    <livewire:emr-r-i.display-pasien.display-pasien :wire:key="$riHdrNoRef.'display-pasienEresep'"
                        :riHdrNoRef="$riHdrNoRef">

                </div>

                <div>
                    <livewire:emr-r-i.eresep-r-i.eresep-r-i-hdr :wire:key="'eresep-r-i-hdr'" :riHdrNoRef="$riHdrNoRef">
                </div>
