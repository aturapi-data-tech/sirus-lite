    ...
    <div class="">
        ...
        <div class="fixed inset-0 transition-opacity">
            <div class="absolute overflow-auto bg-white rounded-t-lg inset-4">
                ...
                <div class="">
                    {{-- Display Pasien --}}
                    {{-- :rjNo="" disi dari emit ListeneropenModalEditdokter --}}

                    <livewire:emr-r-i.display-pasien.display-pasien :wire:key="$riHdrNoRef.'display-pasien-dokter'"
                ...
                <div id="TransaksiEMR" x-data="{ activeTabDokter: @entangle('activeTabDokter') }" class="grid grid-cols-1">
                    ...
                    <div class="w-full mx-2 mr-2 rounded-lg bg-gray-50 "
                        :class="{
                            'active': activeTabDokter === 'pengkajianDokter'
                        }"
                        x-show.transition.in.opacity.duration.600="activeTabDokter === 'pengkajianDokter'">
                        <livewire:emr-r-i.mr-r-i.assessment-pengkajian-dokter.assessment-pengkajian-dokter
                            :wire:key="'content-r-i-pengkajianDokter'" :riHdrNoRef="$riHdrNoRef" :regNoRef="$regNoRef">
                    ...
                    <div class="w-full mx-2 mr-2 rounded-lg bg-gray-50 "
                        :class="{
                            'active': activeTabDokter === 'observasi'
                        }"
                        x-show.transition.in.opacity.duration.600="activeTabDokter === 'observasi'">
                    ...
                    <div class="w-full mx-2 mr-2 rounded-lg bg-gray-50"
                        :class="{
                            'active': activeTabDokter === 'cppt'
                        }"
                        x-show.transition.in.opacity.duration.600="activeTabDokter === 'cppt'">

                        <livewire:emr-r-i.mr-r-i.c-p-p-t.c-p-p-t :wire:key="'content-r-i-cpptRi-dokter'"
                            :riHdrNoRef="$riHdrNoRef">
                    </div>

                    <div class="w-full mx-2 mr-2 rounded-lg bg-gray-50"
                        :class="{
                            'active': activeTabDokter === 'pemeriksaanPenunjang'
                        }"
                        x-show.transition.in.opacity.duration.600="activeTabDokter === 'pemeriksaanPenunjang'">

                        <livewire:emr-r-i.mr-r-i.assessment-dokter-pemeriksaan.assessment-dokter-pemeriksaan
                            :wire:key="'content-r-i-pemeriksaanPenunjangRi-dokter'" :riHdrNoRef="$riHdrNoRef">
                    </div>
                    ...
                    <div class="w-full mx-2 mr-2 rounded-lg bg-gray-50 "
                        ...
                        <livewire:emr.laborat.laborat :wire:key="'content-r-i-pelayananPenunjangLab'" :regNoRef="$regNoRef">
                            <livewire:emr.radiologi.radiologi :wire:key="'content-r-i-pelayananPenunjangRad'"
                                :regNoRef="$regNoRef">
                    </div>
                    ...
                    <div class="w-full mx-2 mr-2 rounded-lg bg-gray-50 "
                        ...
                        <livewire:emr.rekam-medis.rekam-medis :wire:key="'content-r-i-rekamMedis'" :regNoRef="$regNoRef">
                    </div>
