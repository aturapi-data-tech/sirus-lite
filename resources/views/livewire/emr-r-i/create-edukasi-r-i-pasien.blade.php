        ...
        <div class="fixed inset-0 transition-opacity">
            <div class="absolute overflow-auto bg-white rounded-t-lg inset-4">
                ...
                <div
                    ...
                    <div id="edukasi-pasien-shiftTanggal" class="flex justify-end w-full mr-4">


                        {{-- Close Modal --}}
                        <button wire:click="closeModalEdukasiPasienRI()"
                ...
                <div class="">
                    <livewire:emr-r-i.display-pasien.display-pasien
                        :wire:key="$regNoRef.'display-pasien-edukasi-pasien'" :riHdrNoRef="$riHdrNoRef">
                </div>


                {{-- Transasi EMR --}}
                <div id="edukasi-pasien-TransaksiEMR" x-data="{ activeTabEdukasiPasienRI: @entangle('activeTabEdukasiPasienRI') }" class="grid grid-cols-1">
                    ...
                    <div class="px-2 mb-0 overflow-auto border-b border-gray-200">
                        <ul
                            ...
                            @foreach ($EmrMenuEdukasiPasienRI as $EmrM)
                                <li wire:key="tab-{{ $EmrM['ermMenuId'] }}" class="mx-1 mr-0 rounded-t-lg "
                                    x-bind:class="activeTabEdukasiPasienRI
                                    === '{{ $EmrM['ermMenuId'] }}' ?
                                        'text-primary border-primary bg-gray-100' :
                                        'border border-gray-200'">
                                    <label
                                        class="inline-block p-2 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300"
                                        x-on:click="activeTabEdukasiPasienRI ='{{ $EmrM['ermMenuId'] }}'"
                                        wire:click="$set('activeTabEdukasiPasienRI', '{{ $EmrM['ermMenuId'] }}')">{{ $EmrM['ermMenuName'] }}</label>
                                </li>
                            @endforeach
                    ...
                    <div class="w-full mx-2 mr-2 rounded-lg bg-gray-50 "
                        :class="{
                            'active': activeTabEdukasiPasienRI === 'edukasiPasienRI'
                        }"
                        x-show.transition.in.opacity.duration.600="activeTabEdukasiPasienRI === 'edukasiPasienRI'">
