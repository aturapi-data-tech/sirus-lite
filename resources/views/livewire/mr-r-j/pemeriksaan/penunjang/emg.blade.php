<div>
    ...
    <x-text-input-area id="dataDaftarPoliRJ.pemeriksaan.emg.keluhanPasien" placeholder="Keluhan Pasien"
        class="mt-1 ml-2" :errorshas="__($errors->has('dataDaftarPoliRJ.pemeriksaan.emg.keluhanPasien'))" :disabled=$disabledPropertyRjStatus
