        ...
        <div class="fixed inset-0 transition-opacity">
            <div class="absolute overflow-auto bg-white rounded-t-lg inset-4">
                ...
                <div class="grid grid-cols-2">
                    <livewire:daftar-r-i.display-pasien.display-pasien :regNo="$regNoRef"
                        :wire:key="$regNoRef.'display-pasien'">

                        <livewire:daftar-r-i.form-entry-r-i.form-entry-r-i :riHdrNo="$riHdrNoRef"
                            :wire:key="$riHdrNoRef.'form-entry-r-i'">
