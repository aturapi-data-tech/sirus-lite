                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="p-2 m-2 border-b-2 border-l-2 border-r-2 border-black">
                            {!! nl2br(
                                e(
                                    !empty($dataDaftarTxn['anamnesa']['keluhanUtama']['keluhanUtama'])
                    ...
                    <tr>
                        ...
                        <td class="p-2 m-2 border-b-2 border-l-2 border-r-2 border-black">
                            {!! nl2br(
                                e(!empty($dataDaftarTxn['pemeriksaan']['penunjang']) ? $dataDaftarTxn['pemeriksaan']['penunjang'] : '-'),
                            ) !!}
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="p-2 m-2 border-b-2 border-l-2 border-r-2 border-black">
                            {!! nl2br(e(!empty($dataDaftarTxn['procedureFreeText']) ? $dataDaftarTxn['procedureFreeText'] : '-')) !!}
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="p-2 m-2 border-b-2 border-l-2 border-r-2 border-black">
                            {{ !empty($dataDaftarTxn['pemeriksaan']['suspekAkibatKerja']['suspekAkibatKerja'])
                                ? $dataDaftarTxn['pemeriksaan']['suspekAkibatKerja']['suspekAkibatKerja']
                                : '-' }}
                            {{ !empty($dataDaftarTxn['pemeriksaan']['suspekAkibatKerja']['keteranganSuspekAkibatKerja'])
