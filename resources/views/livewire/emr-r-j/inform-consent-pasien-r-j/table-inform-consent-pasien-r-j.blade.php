<div class="h-[calc(100vh-250px)] mt-2 overflow-auto">
    ...
    <table class="w-full text-sm text-left text-gray-700 table-auto ">
        ...
        <tbody class="bg-white ">
            @isset($dataDaftarPoliRJ['informConsentPasienRJ'])
                @foreach ($dataDaftarPoliRJ['informConsentPasienRJ'] as $myQData)
                    <tr class="border-b group dark:border-gray-700"
                        wire:click="setInformConsentPasienRJ({{ json_encode($myQData, true) }})">
