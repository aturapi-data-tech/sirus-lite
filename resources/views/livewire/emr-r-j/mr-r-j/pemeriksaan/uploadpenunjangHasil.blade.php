    ...
    <div class="my-2">
        ...
        <table class="w-full text-sm text-left text-gray-500 table-auto ">
            ...
            <tbody class="bg-white ">
                @isset($dataDaftarPoliRJ['pemeriksaan']['uploadHasilPenunjang'])
                    @foreach ($dataDaftarPoliRJ['pemeriksaan']['uploadHasilPenunjang'] as $key => $uploadHasilPenunjang)
...
@if ($isOpenRekamMedisuploadpenunjangHasil)
    @include('livewire.emr-r-j.mr-r-j.pemeriksaan.create-uploadpenunjangHasil')
@endif
