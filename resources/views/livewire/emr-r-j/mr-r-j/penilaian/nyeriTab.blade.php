        ...
        <div class="pt-0">
            ...
            <div class="pt-2 ">
                ...
                <div class="grid grid-cols-11 gap-2 mt-2 ml-2">
                    @foreach ($dataDaftarPoliRJ['penilaian']['nyeri']['vas']['vasOptions'] as $vasOptions)
                        @php
                        ...
                        <x-radio-button :label="__($vasOptions['vas'])" value="{{ $vasOptions['vas'] }}"
                            wire:model="dataDaftarPoliRJ.penilaian.nyeri.vas.vas" class="{{ $vasColor }}" />
                    @endforeach
            ...
            {{-- <div class="pt-2 ">
                ...
                <div class="mt-2 ml-2">
                    <x-input-label for="dataDaftarPoliRJ.penilaian.nyeri.skalaNyeri" :value="__('Skala Nyeri')" :required="__(false)"
                        class="px-2" />
