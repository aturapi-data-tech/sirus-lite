        ...
        <div class="grid grid-cols-1">
            ...
            @role(['Mr', 'Admin'])
                <div id="TransaksiRawatJalan" class="px-4">
                    <x-input-label for="" :value="__('Diagnosis dan Procedure')" :required="__(false)" class="pt-2 sm:text-xl" />
            ...
            <div id="TransaksiRawatJalanFreeText" class="px-4">
                <div>
                    <x-input-label for="dataDaftarPoliRJ.diagnosisFreeText" :value="__('Diagnosis')" :required="__(true)"
                        class="pt-2 sm:text-xl" />

                    <div class="mb-2 ">
                        <x-text-input-area id="dataDaftarPoliRJ.diagnosisFreeText" placeholder="Diagnosis"
                            class="mt-1 ml-2" :errorshas="__($errors->has('dataDaftarPoliRJ.diagnosisFreeText'))" :disabled=$disabledPropertyRjStatus :rows=7
                            wire:model.debounce.500ms="dataDaftarPoliRJ.diagnosisFreeText" />

                    </div>
                    @error('dataDaftarPoliRJ.diagnosisFreeText')
                        <x-input-error :messages=$message />
                    @enderror
                </div>

                <div>
                    <x-input-label for="dataDaftarPoliRJ.procedureFreeText" :value="__('Procedure')" :required="__(true)"
                        class="pt-2 sm:text-xl" />

                    <div class="mb-2 ">
                        <x-text-input-area id="dataDaftarPoliRJ.procedureFreeText" placeholder="Procedure"
                            class="mt-1 ml-2" :errorshas="__($errors->has('dataDaftarPoliRJ.procedureFreeText'))" :disabled=$disabledPropertyRjStatus :rows=7
                            wire:model.debounce.500ms="dataDaftarPoliRJ.procedureFreeText" />

                    </div>
                    @error('dataDaftarPoliRJ.procedureFreeText')
                        <x-input-error :messages=$message />
                    @enderror
                </div>
            </div>
