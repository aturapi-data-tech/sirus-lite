<div class="grid grid-cols-4 gap-1">
    ...
    <x-light-button wire:click.prevent="postPenerimaanResepRJ()" type="button" wire:loading.remove
        wire:target="postPenerimaanResepRJ">
        Terima Resep
    </x-light-button>
    <div wire:loading wire:target="postPenerimaanResepRJ">
        <x-loading />
    </div>
    ...
    <x-light-button wire:click.prevent="postLaboratRJ()" type="button" wire:loading.remove wire:target="postLaboratRJ">
        Kirim Laborat
    </x-light-button>
    <div wire:loading wire:target="postLaboratRJ">
        <x-loading />
    </div>

    <x-light-button wire:click.prevent="postSpecimenLaboratRJ()" type="button" wire:loading.remove
        wire:target="postSpecimenLaboratRJ">
        Kirim Speciment Laborat
    </x-light-button>
    <div wire:loading wire:target="postSpecimenLaboratRJ">
        <x-loading />
    </div>
