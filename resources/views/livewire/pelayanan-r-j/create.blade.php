        ...
        <div class="inline-block overflow-auto text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl sm:max-h-[35rem] sm:my-8 sm:align-middle  sm:w-11/12"
            ...
            <form>
                ...
                <div class="px-4 pt-5 pb-4 bg-white sm:p-6 sm:pb-4">
                    ...
                    {{-- --------------------------------------------------------------- --}}
                    @include('livewire.pelayanan-r-j.create-screening-pasien')
                    {{-- --------------------------------------------------------------- --}}
                    @include('livewire.pelayanan-r-j.create-screening-kesimpulan')

                    <div class="flex ">
                        {{-- --------------------------------------------------------------- --}}
                        @include('livewire.pelayanan-r-j.create-tanda-vital-pasien')
                        {{-- --------------------------------------------------------------- --}}
                        @include('livewire.pelayanan-r-j.create-antropometri-pasien')
                        {{-- --------------------------------------------------------------- --}}
                        @include('livewire.pelayanan-r-j.create-fungsional-pasien')
                    </div>
