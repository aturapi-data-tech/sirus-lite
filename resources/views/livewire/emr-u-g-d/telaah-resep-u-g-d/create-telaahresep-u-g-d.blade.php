<div class="fixed inset-0 z-40">
    @php
        ...
        $disabledPropertyRjStatusResep = isset($dataDaftarUgd['telaahResep']['penanggungJawab']) ? true : false;
        $disabledPropertyRjStatusObat = isset($dataDaftarUgd['telaahObat']['penanggungJawab']) ? true : false;
        ...
        <div class="fixed inset-0 transition-opacity">
            <div class="absolute overflow-auto bg-white rounded-t-lg inset-4">
                ...
                <div class="">
                    ...
                    <livewire:emr-u-g-d.display-pasien.display-pasien :wire:key="$rjNoRef.'display-pasienEresep'"
                        :rjNoRef="$rjNoRef">
                    ...
                    <div class="col-span-2">
                        ...
                        <div id="TransaksiEMR" x-data="{ activeTabRacikanNonRacikan: @entangle('activeTabRacikanNonRacikan') }" class="grid grid-cols-1">
                            ...
                            <div class="w-full mx-2 mr-2 rounded-lg bg-gray-50"
                                ...
                                <livewire:emr-u-g-d.eresep-u-g-d.eresep-u-g-d :wire:key="'eresep-u-g-d'"
                                    :rjNoRef="$rjNoRef">
                            ...
                            <div class="w-full mx-2 mr-2 rounded-lg bg-gray-50"
                                ...
                                <livewire:emr-u-g-d.eresep-u-g-d.eresep-u-g-d-racikan :wire:key="'eresep-u-g-d-racikan'"
                                    :rjNoRef="$rjNoRef">
                        ...
                        @role(['Apoteker', 'Admin'])
                            <div class="grid w-full grid-cols-2 gap-8 px-8 mx-2 my-2 mr-2 rounded-lg bg-gray-50">
                                @include('livewire.emr-u-g-d.telaah-resep-u-g-d.radio-telaahresep-u-g-d')
                                @include('livewire.emr-u-g-d.telaah-resep-u-g-d.radio-telaahobat-u-g-d')
                            </div>
                        @endrole
