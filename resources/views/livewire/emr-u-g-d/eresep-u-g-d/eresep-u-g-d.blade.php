                                                        ...
                                                        <td
                                                            ...
                                                            <div>
                                                                <x-text-input placeholder="Jml Racikan" class=""
                                                                    ...
                                                                    x-ref="dataDaftarUgderesep{{ $key }}qty"
                                                                    x-on:keyup.enter="$refs.dataDaftarUgderesep{{ $key }}signaX.focus()" />
                                                            </div>
                                                        </td>
                                                                ...
                                                                <div class="basis-[20%]">
                                                                    ...
                                                                    <div>
                                                                        <x-text-input placeholder="Signa1"
                                                                            ...
                                                                            x-ref="dataDaftarUgderesep{{ $key }}signaX"
                                                                            x-on:keyup.enter="$refs.dataDaftarUgderesep{{ $key }}signaHari.focus()" />
                                                                ...
                                                                <div class="basis-[20%]">
                                                                    ...
                                                                    <div>
                                                                        <x-text-input placeholder="Signa2"
                                                                            ...
                                                                            x-ref="dataDaftarUgderesep{{ $key }}signaHari"
                                                                            x-on:keyup.enter="$refs.dataDaftarUgderesep{{ $key }}catatanKhusus.focus()" />
                                                                ...
                                                                <div class="basis-3/6">
                                                                    ...
                                                                    <div>
                                                                        <x-text-input placeholder="Catatan Khusus"
                                                                            ...
                                                                            x-on:keyup.enter="$wire.updateProduct('{{ $dataDaftarUgd['eresep'][$key]['rjObatDtl'] ? $dataDaftarUgd['eresep'][$key]['rjObatDtl'] : null }}', '{{ $dataDaftarUgd['eresep'][$key]['qty'] ? $dataDaftarUgd['eresep'][$key]['qty'] : null }}','{{ $dataDaftarUgd['eresep'][$key]['signaX'] ? $dataDaftarUgd['eresep'][$key]['signaX'] : null }}', '{{ $dataDaftarUgd['eresep'][$key]['signaHari'] ? $dataDaftarUgd['eresep'][$key]['signaHari'] : null }}', '{{ $dataDaftarUgd['eresep'][$key]['catatanKhusus'] ? $dataDaftarUgd['eresep'][$key]['catatanKhusus'] : null }}')
                                                                        $refs.dataDaftarUgderesep{{ $key }}qty.focus()"
                                                                            x-ref="dataDaftarUgderesep{{ $key }}catatanKhusus" />
