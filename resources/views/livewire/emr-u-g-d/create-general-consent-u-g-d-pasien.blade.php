            ...
            <div class="absolute overflow-auto bg-white rounded-t-lg inset-4">
                ...
                <div
                    ...
                    <h3 class="w-full text-2xl font-semibold text-white ">
                        {{ 'Form Persetujuan dan Penjaminan' }}
                    </h3>
                    ...
                    <div id="general-conset-pasien-shiftTanggal" class="flex justify-end w-full mr-4">
                        ...
                        {{-- Close Modal --}}
                        <button wire:click="closeModalGeneralConsentPasienUGD()"
                ...
                {{-- Transasi EMR --}}
                <div id="general-conset-pasien-TransaksiEMR" x-data="{ activeTabGeneralConsentPasienUGD: @entangle('activeTabGeneralConsentPasienUGD') }" class="grid grid-cols-1">
                    ...
                    <div class="px-2 mb-0 overflow-auto border-b border-gray-200">
                        <ul
                            ...
                            @foreach ($EmrMenuGeneralConsentPasienUGD as $EmrM)
                                <li wire:key="tab-{{ $EmrM['ermMenuId'] }}" class="mx-1 mr-0 rounded-t-lg "
                                    x-bind:class="activeTabGeneralConsentPasienUGD
                                    === '{{ $EmrM['ermMenuId'] }}' ?
                                        'text-primary border-primary bg-gray-100' :
                                        'border border-gray-200'">
                                    <label
                                        class="inline-block p-2 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300"
                                        x-on:click="activeTabGeneralConsentPasienUGD ='{{ $EmrM['ermMenuId'] }}'"
                                        wire:click="$set('activeTabGeneralConsentPasienUGD', '{{ $EmrM['ermMenuId'] }}')">{{ $EmrM['ermMenuName'] }}</label>
                                </li>
                            @endforeach
                    ...
                    <div class="w-full mx-2 mr-2 rounded-lg bg-gray-50 "
                        :class="{
                            'active': activeTabGeneralConsentPasienUGD === 'generalConsentPasienUGD'
                        }"
