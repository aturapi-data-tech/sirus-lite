        ...
        <div class="pt-0">
            ...
            <div class="mb-2 ">
                ...
                <x-text-input id="" placeholder="" class="mt-1 ml-2" :errorshas="__($errors->has(''))" :disabled=true
                    wire:model.debounce.500ms="dataDaftarUgd.penilaian.resikoJatuh.edmonson.edmonsonUsia" />
            </div>

            <div class="grid grid-flow-row gap-2 mt-2 ml-2">
                <x-input-label for="" :value="__('Status Mental')" :required="__(false)" class="px-2" />

                @foreach ($dataDaftarUgd['penilaian']['resikoJatuh']['edmonson']['statusMentalOptions'] as $statusMentalOptions)
                    {{-- @dd($sRj) --}}
                    <x-radio-button :label="__($statusMentalOptions['statusMental'])" value="{{ $statusMentalOptions['statusMental'] }}"
                        wire:model="dataDaftarUgd.penilaian.resikoJatuh.edmonson.statusMental" />
                @endforeach
            ...
            <div class="grid grid-flow-row gap-2 mt-2 ml-2">
                ...
                @foreach ($dataDaftarUgd['penilaian']['resikoJatuh']['edmonson']['eliminasiOptions'] as $eliminasiOptions)
                    {{-- @dd($sRj) --}}
                    <x-radio-button :label="__($eliminasiOptions['eliminasi'])" value="{{ $eliminasiOptions['eliminasi'] }}"
                        wire:model="dataDaftarUgd.penilaian.resikoJatuh.edmonson.eliminasi" />
                @endforeach
            ...
            <div class="grid grid-flow-row gap-2 mt-2 ml-2">
                ...
                @foreach ($dataDaftarUgd['penilaian']['resikoJatuh']['edmonson']['medikasiOptions'] as $medikasiOptions)
                    {{-- @dd($sRj) --}}
                    <x-radio-button :label="__($medikasiOptions['medikasi'])" value="{{ $medikasiOptions['medikasi'] }}"
                        wire:model="dataDaftarUgd.penilaian.resikoJatuh.edmonson.medikasi" />
                @endforeach
            ...
            <div class="grid grid-flow-row gap-2 mt-2 ml-2">
                ...
                @foreach ($dataDaftarUgd['penilaian']['resikoJatuh']['edmonson']['diagnosisOptions'] as $diagnosisOptions)
                    {{-- @dd($sRj) --}}
                    <x-radio-button :label="__($diagnosisOptions['diagnosis'])" value="{{ $diagnosisOptions['diagnosis'] }}"
                        wire:model="dataDaftarUgd.penilaian.resikoJatuh.edmonson.diagnosis" />
                @endforeach
            ...
            <div class="grid grid-flow-row gap-2 mt-2 ml-2">
                ...
                @foreach ($dataDaftarUgd['penilaian']['resikoJatuh']['edmonson']['ambulasiOptions'] as $ambulasiOptions)
                    {{-- @dd($sRj) --}}
                    <x-radio-button :label="__($ambulasiOptions['ambulasi'])" value="{{ $ambulasiOptions['ambulasi'] }}"
                        wire:model="dataDaftarUgd.penilaian.resikoJatuh.edmonson.ambulasi" />
                @endforeach
            ...
            <div class="grid grid-flow-row gap-2 mt-2 ml-2">
                ...
                @foreach ($dataDaftarUgd['penilaian']['resikoJatuh']['edmonson']['nutrisiOptions'] as $nutrisiOptions)
                    {{-- @dd($sRj) --}}
                    <x-radio-button :label="__($nutrisiOptions['nutrisi'])" value="{{ $nutrisiOptions['nutrisi'] }}"
                        wire:model="dataDaftarUgd.penilaian.resikoJatuh.edmonson.nutrisi" />
                @endforeach
            ...
            <div class="grid grid-flow-row gap-2 mt-2 ml-2">
                ...
                @foreach ($dataDaftarUgd['penilaian']['resikoJatuh']['edmonson']['ganguanTidurOptions'] as $ganguanTidurOptions)
                    {{-- @dd($sRj) --}}
                    <x-radio-button :label="__($ganguanTidurOptions['ganguanTidur'])" value="{{ $ganguanTidurOptions['ganguanTidur'] }}"
                        wire:model="dataDaftarUgd.penilaian.resikoJatuh.edmonson.ganguanTidur" />
                @endforeach
            ...
            <div class="grid grid-flow-row gap-2 mt-2 ml-2">
                ...
                @foreach ($dataDaftarUgd['penilaian']['resikoJatuh']['edmonson']['riwayatJatuhOptions'] as $riwayatJatuhOptions)
                    {{-- @dd($sRj) --}}
                    <x-radio-button :label="__($riwayatJatuhOptions['riwayatJatuh'])" value="{{ $riwayatJatuhOptions['riwayatJatuh'] }}"
                        wire:model="dataDaftarUgd.penilaian.resikoJatuh.edmonson.riwayatJatuh" />
                @endforeach
            ...
            <div class="grid grid-flow-row gap-2 mt-2 ml-2">
                ...
                @foreach ($dataDaftarUgd['penilaian']['resikoJatuh']['edmonson']['faktorLingkunganOptions'] as $faktorLingkunganOptions)
                    {{-- @dd($sRj) --}}
                    <x-radio-button :label="__($faktorLingkunganOptions['faktorLingkungan'])" value="{{ $faktorLingkunganOptions['faktorLingkungan'] }}"
                        wire:model="dataDaftarUgd.penilaian.resikoJatuh.edmonson.faktorLingkungan" />
                @endforeach
            ...
            <div class="grid grid-flow-row gap-2 mt-2 ml-2">
                ...
                @foreach ($dataDaftarUgd['penilaian']['resikoJatuh']['edmonson']['penggunaanObatOptions'] as $penggunaanObatOptions)
                    {{-- @dd($sRj) --}}
                    <x-radio-button :label="__($penggunaanObatOptions['penggunaanObat'])" value="{{ $penggunaanObatOptions['penggunaanObat'] }}"
                        wire:model="dataDaftarUgd.penilaian.resikoJatuh.edmonson.penggunaanObat" />
                @endforeach
            ...
            <div class="grid grid-flow-row gap-2 mt-2 ml-2">
                ...
                @foreach ($dataDaftarUgd['penilaian']['resikoJatuh']['edmonson']['responTerhadapOperasiOptions'] as $responTerhadapOperasiOptions)
                    {{-- @dd($sRj) --}}
                    <x-radio-button :label="__($responTerhadapOperasiOptions['responTerhadapOperasi'])"
                        ...
                        wire:model="dataDaftarUgd.penilaian.resikoJatuh.edmonson.responTerhadapOperasi" />
                @endforeach
