        ...
        <div class="grid grid-cols-1">
            ...
            @role(['Mr', 'Admin'])
                <div id="TransaksiRawatJalan" class="px-4">
                    ...
                    <div>
                        {{-- LOV Diagnosa --}}
                        @include('livewire.emr-u-g-d.mr-u-g-d.diagnosis.list-of-value-caridataDiagnosaICD10')
                    </div>
                                ...
                                <div class="overflow-hidden shadow sm:rounded-lg">
                                    <table class="w-full text-sm text-left text-gray-500 table-auto dark:text-gray-400">
                                        ...
                                        <tbody class="bg-white dark:bg-gray-800">
                                            @isset($dataDaftarUgd['diagnosis'])
                                                @foreach ($dataDaftarUgd['diagnosis'] as $key => $diag)
                    ...
                    <div>
                        {{-- LOV Diagnosa --}}
                        @include('livewire.emr-u-g-d.mr-u-g-d.diagnosis.list-of-value-caridataProcedureICD9Cm')
                    </div>
                                ...
                                <div class="overflow-hidden shadow sm:rounded-lg">
                                    <table class="w-full text-sm text-left text-gray-500 table-auto dark:text-gray-400">
                                        ...
                                        <tbody class="bg-white dark:bg-gray-800">
                                            ...
                                            @isset($dataDaftarUgd['procedure'])
                                                @foreach ($dataDaftarUgd['procedure'] as $key => $procedure)
                                                    <tr class="border-b group dark:border-gray-700">
            ...
            <div id="TransaksiRawatJalanFreeText" class="px-4">
                <div>
                    <x-input-label for="dataDaftarUgd.diagnosisFreeText" :value="__('Diagnosis')" :required="__(true)"
                ...
                <div>
                    <x-input-label for="dataDaftarUgd.procedureFreeText" :value="__('Procedure')" :required="__(true)"
                        class="pt-2 sm:text-xl" />
