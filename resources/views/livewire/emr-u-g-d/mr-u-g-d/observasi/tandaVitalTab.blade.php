<div>
    <div class="w-full mb-1">
        ...
        <div class="pt-0">
            ...
            <div class="mb-2 ">
                <x-text-input id="observasiLanjutan.cairan" placeholder="cairan" class="mt-1 ml-2" :errorshas="__($errors->has('observasiLanjutan.cairan'))"
                    :disabled=$disabledPropertyRjStatus wire:model.debounce.500ms="observasiLanjutan.cairan" />
            ...
            <div class="mb-2 ">
                <x-text-input id="observasiLanjutan.tetesan" placeholder="tetesan" class="mt-1 ml-2" :errorshas="__($errors->has('observasiLanjutan.tetesan'))"
                    :disabled=$disabledPropertyRjStatus wire:model.debounce.500ms="observasiLanjutan.tetesan" />
            ...
            <div class="mb-2 ">
                <div class="grid grid-cols-2 gap-2">
                    <x-input-label for="observasiLanjutan.frekuensiNafas" :value="__('Frekuensi Nadi')" :required="__(false)" />
                    <x-input-label for="observasiLanjutan.frekuensiNafas" :value="__('Frekuensi Nafas')" :required="__(false)" />
                </div>

                <div class="grid grid-cols-2 gap-2">
                    <x-text-input-mou id="observasiLanjutan.frekuensiNadi" placeholder="Frekuensi Nadi"
                        class="mt-1 ml-2" :errorshas="__($errors->has('observasiLanjutan.frekuensiNadi'))" :disabled=$disabledPropertyRjStatus :mou_label="__('X/Menit')"
                        wire:model.debounce.500ms="observasiLanjutan.frekuensiNadi" />
                    <x-text-input-mou id="observasiLanjutan.frekuensiNafas" placeholder="Frekuensi Nafas"
                        class="mt-1 ml-2" :errorshas="__($errors->has('observasiLanjutan.frekuensiNafas'))" :disabled=$disabledPropertyRjStatus :mou_label="__('X/Menit')"
                        wire:model.debounce.500ms="observasiLanjutan.frekuensiNafas" />
                </div>
            </div>
            ...
            <div class="mb-2 ">
                ...
                <div class="grid grid-cols-2 gap-2">
                    ...
                    <x-text-input-mou id="observasiLanjutan.gda" placeholder="GDA" class="mt-1 ml-2" :errorshas="__($errors->has('observasiLanjutan.gda'))"
