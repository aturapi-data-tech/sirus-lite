            ...
            <div id="TransaksiRawatJalan" class="px-2">
                <div id="TransaksiRawatJalan" x-data="{ activeTab: 'Umum' }">
                        ...
                        <ul
                            ...
                            <li class="mr-2">
                                <label
                                    ...
                                    :class="activeTab === '{{ $dataDaftarUgd['pemeriksaan']['umumTab'] }}' ?
                                        'text-primary border-primary bg-gray-100' : ''"
                                    @click="activeTab ='{{ $dataDaftarUgd['pemeriksaan']['umumTab'] }}'">{{ $dataDaftarUgd['pemeriksaan']['umumTab'] }}</label>
                            </li>
                    ...
                    <div class="p-2 rounded-lg bg-gray-50 dark:bg-gray-800"
                        :class="{
                            'active': activeTab === '{{ $dataDaftarUgd['pemeriksaan']['umumTab'] }}'
                        }"
                        x-show.transition.in.opacity.duration.600="activeTab === '{{ $dataDaftarUgd['pemeriksaan']['umumTab'] }}'">
