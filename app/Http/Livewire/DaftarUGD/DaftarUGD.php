...
class DaftarUGD extends Component
{
    ...
    private function optionsdrRjRef(): void
    {
        ...
        $query = DB::table('rsview_rjkasir')
            ...
            ->where('shift', '=', $this->myTopBar['refShift'])
    ...
    private function insertDataRJ(): void
    {
        ...
        DB::table('rstxn_rjhdrs')->insert([
            ...
            'rj_date' => DB::raw("to_date('" . $this->myTopBar['refDate'] . "','dd/mm/yyyy hh24:mi:ss')"),
            ...
            'waktu_masuk_pelayanan' => DB::raw("to_date('" . $this->myTopBar['refDate'] . "','dd/mm/yyyy hh24:mi:ss')"), //waktu masuk = rjdate
        ...
        if (!$this->dataDaftarPoliRJ['noAntrian']) {
            ...
            if ($this->dataDaftarPoliRJ['klaimId'] != 'KR') {
                $noUrutAntrian = DB::scalar($sql, [
                    "tgl" => Carbon::createFromFormat('d/m/Y H:i:s', $this->myTopBar['refDate'])->format('dmY'),
            ...
            if ($this->dataDaftarPoliRJ['sep']['noSep']) {
                ...
                if ($this->JenisKlaim['JenisKlaimId'] == 'JM' && $this->JenisKunjungan['JenisKunjunganId'] == 1) {
                    ...
                    if ($this->dataDaftarPoliRJ['postInap']) {
                        $tanggal = Carbon::createFromFormat('d/m/Y H:i:s', $this->myTopBar['refDate'])->format('Y-m-d');
    ...
    private function pushDataAntrian()
    {
        ...
        if ($this->dataDaftarPoliRJ['klaimId'] != 'KR') {
            $rjdate = Carbon::createFromFormat('d/m/Y H:i:s', $this->myTopBar['refDate']); //Tgl RJ
            ...
            // $jadwal_estimasi = Carbon::createFromFormat('d/m/Y H:i:s', $this->myTopBar['refDate'])->timestamp * 1000; //waktu dalam timestamp milisecond
            $jadwal_estimasi = Carbon::createFromFormat('d/m/Y H:i:s', $this->myTopBar['refDate'])->valueOf();
            ...
            $antreanadd = [
                ...
                "tanggalperiksa" => Carbon::createFromFormat('d/m/Y H:i:s', $this->myTopBar['refDate'])->format('Y-m-d'),
        ...
        $noBooking = $this->dataDaftarPoliRJ['noBooking'];
        $this->dataDaftarPoliRJ['taskIdPelayanan']['taskId3'] = $this->myTopBar['refDate'];
        ...
        $this->SEPJsonReq = [
            "request" =>  [
                "t_sep" =>  [
                    ...
                    "tglSep" => "" . Carbon::createFromFormat('d/m/Y H:i:s', $this->myTopBar['refDate'])->format('Y-m-d') . "", //Y-m-d =tgl rj
            ...
            "request" =>  [
                "t_sep" =>  [
                    ...
                    "rujukan" =>  [
                        ...
                        "tglRujukan" => "" . Carbon::createFromFormat('d/m/Y H:i:s', $this->myTopBar['refDate'])->format('Y-m-d') . "", //Y-m-d
                        "noRujukan" => "" . '' . "",
