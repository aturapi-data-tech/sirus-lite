...
class AssessmentPengkajianDokter extends Component
{
    ...
    protected $rules = [
        ...
        'dataDaftarRi.pengkajianDokter.anamnesa.keluhanTambahan' => 'nullable|string|max:1000',
        'dataDaftarRi.pengkajianDokter.anamnesa.riwayatPenyakit.sekarang' => 'nullable|string|max:1000',
        'dataDaftarRi.pengkajianDokter.anamnesa.riwayatPenyakit.dahulu' => 'nullable|string|max:1000',
        'dataDaftarRi.pengkajianDokter.anamnesa.riwayatPenyakit.keluarga' => 'nullable|string|max:1000',
        'dataDaftarRi.pengkajianDokter.anamnesa.jenisAlergi' => 'nullable|string|max:1000',

        // Rekonsiliasi Obat
        'dataDaftarRi.pengkajianDokter.anamnesa.rekonsiliasiObat.*.namaObat' => 'required|string|max:1000',
        'dataDaftarRi.pengkajianDokter.anamnesa.rekonsiliasiObat.*.dosis' => 'required|string|max:1000',
        'dataDaftarRi.pengkajianDokter.anamnesa.rekonsiliasiObat.*.rute' => 'required|string|max:1000',

        // Fisik
        'dataDaftarRi.pengkajianDokter.fisik' => 'nullable|string|max:1000',

        // Anatomi
        'dataDaftarRi.pengkajianDokter.anatomi.*.kelainan' => 'nullable|string|in:Tidak Diperiksa,Tidak Ada Kelainan,Ada',
        'dataDaftarRi.pengkajianDokter.anatomi.*.desc' => 'nullable|string|max:1000|required_if:dataDaftarRi.pengkajianDokter.anatomi.*.kelainan,Ada',

        // Status Lokalis
        'dataDaftarRi.pengkajianDokter.statusLokalis.deskripsiGambar' => 'nullable|string|max:1000',

        // Hasil Pemeriksaan Penunjang
        'dataDaftarRi.pengkajianDokter.hasilPemeriksaanPenunjang.laboratorium' => 'nullable|string|max:1000',
        'dataDaftarRi.pengkajianDokter.hasilPemeriksaanPenunjang.radiologi' => 'nullable|string|max:1000',
        'dataDaftarRi.pengkajianDokter.hasilPemeriksaanPenunjang.penunjangLain' => 'nullable|string|max:1000',

        // Diagnosa/Assesment
        'dataDaftarRi.pengkajianDokter.diagnosaAssesment.diagnosaAwal' => 'nullable|string|max:1000',

        // Rencana
        'dataDaftarRi.pengkajianDokter.rencana.penegakanDiagnosa' => 'nullable|string|max:1000',
        'dataDaftarRi.pengkajianDokter.rencana.terapi' => 'nullable|string|max:1000',
        'dataDaftarRi.pengkajianDokter.rencana.terapiPulang' => 'nullable|string|max:1000',

        'dataDaftarRi.pengkajianDokter.rencana.diet' => 'nullable|string|max:1000',
        'dataDaftarRi.pengkajianDokter.rencana.edukasi' => 'nullable|string|max:1000',
        'dataDaftarRi.pengkajianDokter.rencana.monitoring' => 'nullable|string|max:1000',

        // Tanda Tangan Dokter
        'dataDaftarRi.pengkajianDokter.tandaTanganDokter.dokterPengkaji' => 'nullable|string|max:1000',
        'dataDaftarRi.pengkajianDokter.tandaTanganDokter.dokterPengkajiCode' => 'nullable|string|max:1000',
    ...
    protected $messages = [
        ...
        'dataDaftarRi.pengkajianDokter.anamnesa.keluhanUtama.max' => 'Keluhan utama tidak boleh lebih dari 1000 karakter.',

        'dataDaftarRi.pengkajianDokter.anamnesa.keluhanTambahan.string' => 'Keluhan tambahan harus berupa teks.',
        'dataDaftarRi.pengkajianDokter.anamnesa.keluhanTambahan.max' => 'Keluhan tambahan tidak boleh lebih dari 1000 karakter.',

        'dataDaftarRi.pengkajianDokter.anamnesa.riwayatPenyakit.sekarang.string' => 'Riwayat penyakit sekarang harus berupa teks.',
        'dataDaftarRi.pengkajianDokter.anamnesa.riwayatPenyakit.sekarang.max' => 'Riwayat penyakit sekarang tidak boleh lebih dari 1000 karakter.',

        'dataDaftarRi.pengkajianDokter.anamnesa.riwayatPenyakit.dahulu.string' => 'Riwayat penyakit dahulu harus berupa teks.',
        'dataDaftarRi.pengkajianDokter.anamnesa.riwayatPenyakit.dahulu.max' => 'Riwayat penyakit dahulu tidak boleh lebih dari 1000 karakter.',

        'dataDaftarRi.pengkajianDokter.anamnesa.riwayatPenyakit.keluarga.string' => 'Riwayat penyakit keluarga harus berupa teks.',
        'dataDaftarRi.pengkajianDokter.anamnesa.riwayatPenyakit.keluarga.max' => 'Riwayat penyakit keluarga tidak boleh lebih dari 1000 karakter.',

        'dataDaftarRi.pengkajianDokter.anamnesa.jenisAlergi.string' => 'Jenis alergi harus berupa teks.',
        'dataDaftarRi.pengkajianDokter.anamnesa.jenisAlergi.max' => 'Jenis alergi tidak boleh lebih dari 1000 karakter.',
        ...
        'dataDaftarRi.pengkajianDokter.anamnesa.rekonsiliasiObat.*.namaObat.max' => 'Nama obat tidak boleh lebih dari 1000 karakter.',
        ...
        'dataDaftarRi.pengkajianDokter.anamnesa.rekonsiliasiObat.*.dosis.max' => 'Dosis obat tidak boleh lebih dari 1000 karakter.',
        ...
        'dataDaftarRi.pengkajianDokter.anamnesa.rekonsiliasiObat.*.rute.max' => 'Rute penggunaan obat tidak boleh lebih dari 1000 karakter.',

        // Fisik
        'dataDaftarRi.pengkajianDokter.fisik.string' => 'Pemeriksaan fisik harus berupa teks.',
        'dataDaftarRi.pengkajianDokter.fisik.max' => 'Pemeriksaan fisik tidak boleh lebih dari 1000 karakter.',
        ...
        'dataDaftarRi.pengkajianDokter.anatomi.*.desc.max' => 'Deskripsi tidak boleh lebih dari 1000 karakter.',

        // Status Lokalis
        'dataDaftarRi.pengkajianDokter.statusLokalis.deskripsiGambar.string' => 'Deskripsi gambar harus berupa teks.',
        'dataDaftarRi.pengkajianDokter.statusLokalis.deskripsiGambar.max' => 'Deskripsi gambar tidak boleh lebih dari 1000 karakter.',

        // Hasil Pemeriksaan Penunjang
        'dataDaftarRi.pengkajianDokter.hasilPemeriksaanPenunjang.laboratorium.string' => 'Hasil laboratorium harus berupa teks.',
        'dataDaftarRi.pengkajianDokter.hasilPemeriksaanPenunjang.laboratorium.max' => 'Hasil laboratorium tidak boleh lebih dari 1000 karakter.',

        'dataDaftarRi.pengkajianDokter.hasilPemeriksaanPenunjang.radiologi.string' => 'Hasil radiologi harus berupa teks.',
        'dataDaftarRi.pengkajianDokter.hasilPemeriksaanPenunjang.radiologi.max' => 'Hasil radiologi tidak boleh lebih dari 1000 karakter.',

        'dataDaftarRi.pengkajianDokter.hasilPemeriksaanPenunjang.penunjangLain.string' => 'Hasil penunjang lain harus berupa teks.',
        'dataDaftarRi.pengkajianDokter.hasilPemeriksaanPenunjang.penunjangLain.max' => 'Hasil penunjang lain tidak boleh lebih dari 1000 karakter.',

        // Diagnosa/Assesment
        'dataDaftarRi.pengkajianDokter.diagnosaAssesment.diagnosaAwal.string' => 'Diagnosa awal harus berupa teks.',
        'dataDaftarRi.pengkajianDokter.diagnosaAssesment.diagnosaAwal.max' => 'Diagnosa awal tidak boleh lebih dari 1000 karakter.',

        // Rencana
        'dataDaftarRi.pengkajianDokter.rencana.penegakanDiagnosa.string' => 'Penegakan diagnosa harus berupa teks.',
        'dataDaftarRi.pengkajianDokter.rencana.penegakanDiagnosa.max' => 'Penegakan diagnosa tidak boleh lebih dari 1000 karakter.',

        'dataDaftarRi.pengkajianDokter.rencana.terapi.string' => 'Terapi harus berupa teks.',
        'dataDaftarRi.pengkajianDokter.rencana.terapi.max' => 'Terapi tidak boleh lebih dari 1000 karakter.',

        'dataDaftarRi.pengkajianDokter.rencana.terapiPulang.string' => 'Terapi Pulang harus berupa teks.',
        'dataDaftarRi.pengkajianDokter.rencana.terapiPulang.max' => 'Terapi Pulang tidak boleh lebih dari 1000 karakter.',

        'dataDaftarRi.pengkajianDokter.rencana.diet.string' => 'Diet harus berupa teks.',
        'dataDaftarRi.pengkajianDokter.rencana.diet.max' => 'Diet tidak boleh lebih dari 1000 karakter.',

        'dataDaftarRi.pengkajianDokter.rencana.edukasi.string' => 'Edukasi harus berupa teks.',
        'dataDaftarRi.pengkajianDokter.rencana.edukasi.max' => 'Edukasi tidak boleh lebih dari 1000 karakter.',

        'dataDaftarRi.pengkajianDokter.rencana.monitoring.string' => 'Monitoring harus berupa teks.',
        'dataDaftarRi.pengkajianDokter.rencana.monitoring.max' => 'Monitoring tidak boleh lebih dari 1000 karakter.',

        // Tanda Tangan Dokter
        'dataDaftarRi.pengkajianDokter.tandaTanganDokter.dokterPengkaji.string' => 'Nama dokter pengkaji harus berupa teks.',
        'dataDaftarRi.pengkajianDokter.tandaTanganDokter.dokterPengkaji.max' => 'Nama dokter pengkaji tidak boleh lebih dari 1000 karakter.',

        'dataDaftarRi.pengkajianDokter.tandaTanganDokter.dokterPengkajiCode.string' => 'Kode dokter pengkaji harus berupa teks.',
        'dataDaftarRi.pengkajianDokter.tandaTanganDokter.dokterPengkajiCode.max' => 'Kode dokter pengkaji tidak boleh lebih dari 1000 karakter.',
